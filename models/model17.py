...
class SRBlock(nn.Module):
    def __init__(self, channels, window_size=7):
        ...
        # Branch 2 (changed to 5x5 conv)
        self.pad5_branch2 = nn.ReflectionPad2d(2)
        self.conv1_branch2 = nn.Conv2d(channels, channels, kernel_size=5, padding=0)
        ...
        # Branch 2: replaced with 5x5 conv
        self.pad5_stage2_branch2 = nn.ReflectionPad2d(2)
        self.conv2_branch2 = nn.Conv2d(channels, channels, kernel_size=5, padding=0)
    ...
    def forward(self, x):
        ...
        # Branch 2: 5x5 conv
        x2_hat_padded = self.pad5_stage2_branch2(x2_hat)
